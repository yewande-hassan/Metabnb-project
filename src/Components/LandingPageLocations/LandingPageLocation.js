    ...
    return (
      <div className="">
        <div className="flex flex-col p-3 md:flex-row header">
          <span className={"flex m-auto p-3"}>
            <Image images={MBToken} alt={"MBToken"} height={50} width={50} />
            <p className="paragraph">MBToken</p>
          </span>
          <span className={"flex m-auto p-3"}>
            <Image images={MetaMask} alt={"MBToken"} height={50} width={50} />
